...
import org.dianahep.root4j.interfaces.TStreamerBasicPointer;
import org.dianahep.root4j.interfaces.TStreamerElement;
import org.dianahep.root4j.interfaces.TStreamerInfo;
import org.dianahep.root4j.interfaces.TStreamerLoop;
...
public class StreamerInfoNew extends StreamerInfo implements org.apache.bcel.Constants
{
   ...
   private class MemberNew extends BasicMember
   {
      ...
      public void generateReadCode(InstructionList il, InstructionFactory factory, ConstantPoolGen cp, String className)
      {
	    ...
	    case kULong64:
	       ...
	       varClass.generateReadCode(il, factory, cp);
            ...
            case kCharStar:
               ...
               il.append(factory.createInvoke("org.dianahep.root4j.core.RootInput", "skipBytes", Type.INT, new Type[]
                     {
                        Type.INT
                     }, INVOKEINTERFACE));
	    ...
	    case kOffsetP + kULong64:
            case kOffsetP + kBool:
               il.append(InstructionConstants.DUP);
               il.append(factory.createInvoke("org.dianahep.root4j.core.RootInput", "readByte", Type.BYTE, Type.NO_ARGS, INVOKEINTERFACE));
	    ...
	    case kOffsetL + kBool: 
            ...
            case kStreamLoop:
               if (!varClass.getClassName().equals("TString"))
               {
                  ...
                  il.append(factory.createInvoke("org.dianahep.root4j.core.RootInput", "dump", Type.VOID, Type.NO_ARGS, INVOKEINTERFACE));
                  il.append(InstructionConstants.ACONST_NULL);
               }
               else
               {
                  il.append(factory.createInvoke("org.dianahep.root4j.core.RootInput", "readVersion", Type.INT, Type.NO_ARGS, INVOKEINTERFACE));
                  il.append(InstructionConstants.POP);
   ...
   private class DummyMember extends BasicMember
   {
      ...
      public void generateReadCode(InstructionList il, InstructionFactory factory, ConstantPoolGen cp, String className)
      {
          ...
          il.append(factory.createInvoke("org.dianahep.root4j.core.RootInput", "skipObject", Type.VOID, Type.NO_ARGS, INVOKEINTERFACE));
      }
   }
}
